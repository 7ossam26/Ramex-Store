...
itemsRouter.post('/rolls/fabric-labels/batch', requireRole('owner', 'shop_seller', 'factory_sender'), rollsCtl.getBatchFabricLabels);
...
itemsRouter.get('/rolls/:id/fabric-label', requireRole('owner', 'shop_seller', 'factory_sender'), rollsCtl.getFabricLabel);
