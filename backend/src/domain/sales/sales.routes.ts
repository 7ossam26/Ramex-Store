...
salesRouter.post('/sales/preview', requireRole('owner', 'shop_seller', 'super_admin'), ctl.previewSale);
salesRouter.post('/sales', requireRole('owner', 'shop_seller', 'super_admin'), requireOpenShift, ctl.createSale);
...
salesRouter.post('/invoices/:id/void', requireRole('owner', 'shop_seller', 'super_admin'), requireOpenShift, ctl.voidInvoice);
salesRouter.post(
...
// Returns & Exchanges
salesRouter.post('/returns', requireRole('owner', 'shop_seller', 'super_admin'), requireOpenShift, retCtl.processReturn);
salesRouter.post('/returns/exchange', requireRole('owner', 'shop_seller', 'super_admin'), requireOpenShift, retCtl.processExchange);
...
salesRouter.post('/returns/from-scan', requireRole('owner', 'shop_seller', 'super_admin'), requireOpenShift, retCtl.createScanReturn);
