...
export async function getCurrentShift(_req: Request, res: Response): Promise<void> {
...
export async function exportShiftReport(req: Request, res: Response): Promise<void> {
  const id = Number(req.params.id);
