...
codesRouter.post('/:entity',                   requireRole('super_admin'), ctl.createEntity);
codesRouter.get('/:entity/:id/references',     ctl.listEntityReferences);
codesRouter.patch('/:entity/:id',              requireRole('super_admin'), ctl.updateEntity);
codesRouter.delete('/:entity/:id',             requireRole('super_admin'), ctl.softDeleteEntity);
codesRouter.post('/:entity/:id/restore',       requireRole('super_admin'), ctl.restoreEntity);
