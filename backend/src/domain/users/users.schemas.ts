...
export const Role = z.enum(['owner', 'shop_seller', 'factory_sender', 'super_admin']);
...
export const CreateUserSchema = z.object({
  ...
  role: z.enum(['owner', 'shop_seller', 'factory_sender']),
});

export const UpdateUserSchema = z.object({
  full_name_ar: z.string().min(1).max(128).optional(),
  role: z.enum(['owner', 'shop_seller', 'factory_sender']).optional(),
