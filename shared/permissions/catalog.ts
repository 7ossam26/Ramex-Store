...
export const RESOURCE_GROUPS: ResourceGroup[] = [
  {
    ...
    resources: [
      ...
      { key: 'cash_vault_transfer', actions: ['read', 'write', 'approve'],  descriptionKey: 'cash_vault_transfer' },
...
export const ROLE_DEFAULTS: RoleDefaultsMap = {
  ...
  owner: [
    ...
    { resource: 'cash_vault_transfer', action: 'read',    is_allowed: true  },
    { resource: 'cash_vault_transfer', action: 'write',   is_allowed: true  },
    { resource: 'cash_vault_transfer', action: 'approve', is_allowed: true  },
  ...
  shop_seller: [
    ...
    { resource: 'cash_vault_transfer', action: 'read',    is_allowed: true  },
    { resource: 'cash_vault_transfer', action: 'write',   is_allowed: true  },
    { resource: 'cash_vault_transfer', action: 'approve', is_allowed: false },
  ...
  factory_sender: [
    ...
    { resource: 'cash_drawer',  action: 'approve', is_allowed: false },
    { resource: 'cash_vault_transfer', action: 'read',    is_allowed: false },
    { resource: 'cash_vault_transfer', action: 'write',   is_allowed: false },
    { resource: 'cash_vault_transfer', action: 'approve', is_allowed: false },
    { resource: 'hr',           action: 'view',             is_allowed: false },
    { resource: 'hr',           action: 'manage',           is_allowed: false },
    { resource: 'hr',           action: 'salary.disburse',  is_allowed: false },
