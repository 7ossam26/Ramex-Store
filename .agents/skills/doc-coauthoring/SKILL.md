...
Closes knowledge gaps between user and Codex through meta-questions about:
- Document type
- Audience
- Desired impact
- Templates
...
- Use sub-agents (if available) or have users test manually in a separate Codex session
...
The skill prioritizes creating documents that function effectively when readers—including those pasting content into Codex—encounter them independently.
